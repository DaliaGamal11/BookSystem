...
namespace ConsoleApp_day9_ //delgate 
{
    ...
    class Program
    {
        ...
        {
            new Book("123", "C# Basics", new[] { "Dalia", "Gamal" }, new DateTime(2020, 1, 1), 29.99m),
            new Book("456", "Advanced C#", new[] { "Noha" }, new DateTime(2021, 5, 15), 49.99m),
        };
